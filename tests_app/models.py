...
class Test(models.Model):
    autor = models.ForeignKey(Usuario, on_delete=models.CASCADE, related_name="tests", unique=True, null=False, blank=False)
...
class Pregunta(models.Model):
    test = models.ForeignKey(Test, on_delete=models.CASCADE, related_name="preguntas", null=False, blank=False)
